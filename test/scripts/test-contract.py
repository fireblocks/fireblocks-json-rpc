...
CONTRACT_ADDRESS = Web3.to_checksum_address("0x8A470A36a1BDE8B18949599a061892f6B2c4fFAb")
...
if __name__ == '__main__':
    print('last block number: ', web3.eth.block_number)
    for account in web3.eth.accounts:
        print('account: ', account)
        print('account balance: ', web3.from_wei(web3.eth.get_balance(account), "ether"), ' ETH\n')
